...
export async function runStoryGenerationFacadeExample(): Promise<StoryGenerationResult> {
  const facade = new DefaultStoryGenerationFacade();
  ...
  try {
    ...
    return await facade.generate(VALID_STORY_INPUT);
  } finally {
